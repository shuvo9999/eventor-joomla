...
class SppagebuilderAddonCarouselpro extends SppagebuilderAddons {
	...
	public function render() {
		...
		foreach ($this->addon->settings->sp_carouselpro_item as $key => $value) {
			$hide_title = '';
			$hide_title .= ((int) $value->hide_title_md) ? ' sppb-hidden-md sppb-hidden-lg' : '';
			$hide_title .= ((int) $value->hide_title_sm) ? ' sppb-hidden-sm' : '';
			$hide_title .= ((int) $value->hide_title_xs) ? ' sppb-hidden-xs' : '';

			$hide_content = '';
			$hide_content .= ((int) $value->hide_content_md) ? ' sppb-hidden-md sppb-hidden-lg' : '';
			$hide_content .= ((int) $value->hide_content_sm) ? ' sppb-hidden-sm' : '';
			$hide_content .= ((int) $value->hide_content_xs) ? ' sppb-hidden-xs' : '';

			$hide_button = '';
			$hide_button .= ((int) $value->hide_button_md) ? ' sppb-hidden-md sppb-hidden-lg' : '';
			$hide_button .= ((int) $value->hide_button_sm) ? ' sppb-hidden-sm' : '';
			$hide_button .= ((int) $value->hide_button_xs) ? ' sppb-hidden-xs' : '';
